...
export default{
    ...
    */
    ...
    // mutation을 이용해서 state로 전송이 되면 
    // => <template>에 있는 HTML에 바로 반영
    mutations:{
